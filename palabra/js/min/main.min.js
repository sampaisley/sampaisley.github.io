...
function enterPressed(a){25<rowPad||(inputWord.length&&inputWord.length<wordLength?(alertz("Word too short",1200),shake()):!isInWordList()&&inputWord.length&&inputWord.length==wordLength?(alertz("Not in word list.",1200),shake()):"Enter"==a&&0==box%wordLength&&box<=boxes.length&&enterKeyWorks&&(enterKeyWorks=!enterKeyWorks,start+=5,localStorage.setItem("start",start),end+=5,localStorage.setItem("end",end),checkWord()))}
