...
window.addEventListener("click",a=>{a.target.hasAttribute("data-l")&&(letter=a.target.getAttribute("data-l"),makeWord(letter));"Enter"==letter&&enterPressed(letter)});function alertz(a,b){alertzDiv.classList.remove("d-none");$("#alert").fadeUp(50,function(){console.log("foo")});alertzDiv.innerHTML=`<h1 class="alert">${a}</h1>`;b&&setTimeout(closeAlertz,b)}window.addEventListener("click",function(a){a.target.classList.contains("alert")&&closeAlertz()});
function closeAlertz(){$("#alert").fade(50,!1,function(){alertzDiv.classList.add("d-none");alertzDiv.innerHTML=""})};