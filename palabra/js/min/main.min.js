...
window.addEventListener("click",function(a){a.target.classList.contains("alert")&&closeAlertz()});function closeAlertz(){aalert.fade(50,!1,function(){aalert.putClass("d-none").text("")})}score.lastPlayed<today?(score.gameOver=0,localStorage.setObj("storeScore",score)):setClasses();console.log("520====");
